...
const PANEL_STYLES = `
  ...
  .vp-no-camera {
    ...
    align-items: center;
    height: 100%;
    background: linear-gradient(135deg, #0e1218, #141a24);
  }
    ...
    <>
      ...
      <div className="vp-root">
        ...
        <div className="vp-tabs">
          <button
            className={`vp-tab ${activeTab === 'video' ? 'active' : ''}`}
          ...
          <button
            className={`vp-tab ${activeTab === 'chat' ? 'active' : ''}`}
          ...
          <div className="vp-video-area">
            ...
            <div className="vp-controls">
              {!callActive ? (
                ...
                <>
                  <button
                    className={`vp-ctrl-btn ${!micOn ? 'muted' : ''}`}
                    onClick={onToggleMic}
                  ...
                  <button
                    className={`vp-ctrl-btn ${!cameraOn ? 'muted' : ''}`}
